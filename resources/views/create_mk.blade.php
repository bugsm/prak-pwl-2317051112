    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-gradient-to-r from-purple-500 to-blue-500 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Buat Mata Kuliah Baru</h1>
                    <p class="text-purple-100">Tambahkan mata kuliah baru</p>
                </div>
            </div>
        </div>
        ...
        <div class="px-8 py-8">
            <form action="{{ route('matakuliah.store') }}" method="POST" class="space-y-6">
                ...
                <div class="form-group">
                    <input type="text" id="nama_mk" name="nama_mk" placeholder="Nama Mata Kuliah"
